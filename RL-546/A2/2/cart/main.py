...
def train(no_of_episodes,path):
    ...
    for ep in range(1,episodes+1):
        ...
        while True:  
            ...
            '''
            if Done and time_steps < env._max_episode_steps-10:
                R = -( env._max_episode_steps - time_steps)
        ...
        print("episode: {}/{}, epsilon: {}, time_steps taken: {}, total rewards: {}, greedy actions: {}".format(
                          ep, episodes, np.round(agent.epsilon,2), time_steps-1, episode_rewards, greedy_count))
